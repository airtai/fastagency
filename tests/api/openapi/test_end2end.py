...
class TestOpenAPIEnd2EndGiphyFromApp(OpenAPIEnd2End):
    @pytest.fixture
    def fastapi_app(self) -> FastAPI:
        class Gif(BaseModel):
            id: str
        ...
        def get_gif_by_id(gif_id: int = fastapi.Path()) -> Gif:
            """Get GIF by Id."""
...
from models_tmphap5xp2f import Gif, HTTPValidationError
...
def get_gif_by_id_gifs__gif_id__get(gif_id: int) -> Union[Gif, HTTPValidationError]:
    """
    Get GIF by Id.
    """
    pass
'''
        ...
        suffix = generated_code_path.name
        expected = expected.replace("tmphap5xp2f", suffix)
