...
class MesopUI(MessageProcessorMixin):  # UI
    ...
    def __init__(
        ...
        *,
        ...
        try:
            self.workflow_uuid: str = uuid4().hex
    ...
    _registry: ClassVar[dict[UUID, "MesopUI"]] = {}
    ...
    def register(cls, conversation: "MesopUI") -> None:
        cls._registry[conversation.workflow_uuid] = conversation

    @classmethod
    def get_workflow(cls, workflow_uuid: UUID) -> "MesopUI":
        return cls._registry[workflow_uuid]

    @classmethod
    def unregister(cls, conversation: "MesopUI") -> None:
        del cls._registry[conversation.workflow_uuid]
    ...
    @classmethod
    def respond_to(
        cls, workflow_uuid: UUID, message: str
    ) -> Generator[MesopMessage, None, None]:
        conversation = cls.get_workflow(workflow_uuid)
