...
This repository contains a [`FastAgency`](https://github.com/ag2ai/fastagency) application which uses [NATS](https://nats.io/), [FastAPI](https://fastapi.tiangolo.com/), and [Mesop](https://google.github.io/mesop/). Below, you'll find a guide on how to run the application.
...
5. The `workflow.py` file defines the AG2 workflows. It is imported and used in the files that define the `UI`.
