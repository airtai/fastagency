...
You can report all this in [discussions](https://github.com/ag2ai/fastagency/discussions){.external-link target="_blank"} on GitHub, start [issue](https://github.com/ag2ai/fastagency/issues){.external-link target="_blank"}, or write about it in our [discord](https://discord.gg/kJjSGWrknU){.external-link target="_blank"} group.
