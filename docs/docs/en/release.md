...
* Add dependency injection by [@rjambrecic](https://github.com/rjambrecic){.external-link target="_blank"} in [#609](https://github.com/airtai/fastagency/pull/609){.external-link target="_blank"}
