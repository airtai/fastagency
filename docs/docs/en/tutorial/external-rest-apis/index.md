...
```python
{! docs_src/tutorial/external-rest-apis/main.py [ln:1-11] !}
```
...
```python
{! docs_src/tutorial/external-rest-apis/main.py [ln:14-56] !}
```
...
```python
{! docs_src/tutorial/external-rest-apis/main.py [ln:59-61] !}
```
