...
You need to define the workflow that your application will use. This is where you specify how the agents interact and what they do. Here's a simple example of a workflow definition as it is generated by the coockie cutter under `my_fastagency_app/workflow.py`:
...
Depending on the interface you choose, `cookiecutter` will generate appropriate files under `my_fastagency_app/deployment` folder. We'll quickly explain what they contain and how to use them.

#### Imports

First, you'll need to import different modules. These imports set up the necessary components for your application:
