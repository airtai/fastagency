...
- Using a [**proxy server that provides an OpenAI-compatible API**](https://docs.ag2.ai/latest/docs/user-guide/models/litellm-proxy-server/installation/){target="_blank"} or
- By [**using a custom model client class**](https://docs.ag2.ai/latest/docs/blog/2024/01/26/Custom-Models/){target="_blank"}, which lets you define and load your own models.
